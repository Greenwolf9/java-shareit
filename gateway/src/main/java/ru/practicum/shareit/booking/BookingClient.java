...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllBookingsByState(String state,
                                                        Long userId,
                                                        int from, int size) {
    ...
    public ResponseEntity<Object> findAllByOwnerIdAndItem(Long userId, String state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
